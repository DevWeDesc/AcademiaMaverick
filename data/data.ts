...
export const ActiviesData: IActivies[] = [
  {
    ...
    activies: [
      { hour: "07h", name: "Pilates" },
      { hour: "07h30", name: "Pilates" },
      { hour: "08h", name: "Cross Training" },
      { hour: "08h30", name: "Cross Training" },
      { hour: "09h", name: "Fit Dance" },
      { hour: "09h30", name: "Fit Dance" },
      { hour: "18h", name: "Pilates" },
      { hour: "18h30", name: "Pilates" },
      { hour: "19h", name: "Fit Dance" },
      { hour: "19h30", name: "Fit Dance" },
      { hour: "20h", name: "Gap" },
      { hour: "20h30", name: "Gap" },
    ],
  },
  {
    ...
    activies: [
      { hour: "", name: "" },
      { hour: "", name: "" },
      { hour: "09h", name: "Abdominal + Alongamento" },
      { hour: "09h30", name: "Abdominal + Alongamento" },
      { hour: "", name: "" },
      { hour: "", name: "" },
      { hour: "18h", name: "Cross Kids" },
      { hour: "18h30", name: "Cross Kids" },
      { hour: "19h", name: "Cross Training" },
      { hour: "19h30", name: "Cross Training" },
      { hour: "20h", name: "Muay Thai" },
      { hour: "20h30", name: "Muay Thai" },
    ],
  },
  {
    ...
    activies: [
      ...
      { hour: "09h", name: "Fit Dance" },
      { hour: "09h30", name: "Fit Dance" },
      { hour: "18h", name: "Abdominal e Alongamento" },
      { hour: "18h30", name: "Abdominal e Alongamento" },
      { hour: "19h", name: "Fit Dance" },
      { hour: "19h30", name: "Fit Dance" },
      { hour: "20h", name: "Step" },
      { hour: "20h30", name: "Step" },
    ],
  },
  {
    ...
    activies: [
      ...
      { hour: "18h", name: "Cross Kids" },
      { hour: "18h30", name: "Cross Kids" },
      { hour: "19h", name: "Muay Thai" },
      { hour: "19h30", name: "Muay Thai" },
      { hour: "20h", name: "Cross Training" },
      { hour: "20h30", name: "Cross Training" },
    ],
  },
  {
    dayWeek: "Sexta-Feira",
    activies: [
      { hour: "07h", name: "Muay Thai" },
      { hour: "07h30", name: "Muay Thai" },
      { hour: "08h", name: "Cross Training" },
      { hour: "08h30", name: "Cross Training" },
      { hour: "09h", name: "Fit Dance" },
      { hour: "09h30", name: "Fit Dance" },
