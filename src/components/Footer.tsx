...
export const Footer = () => {
  return (
    <div className="font-sans bg-black text-white flex flex-col items-center py-8 gap-10 border-t-[2px] border-[#222222] lg:flex-row lg:justify-between lg:px-36 4xl:px-96">
