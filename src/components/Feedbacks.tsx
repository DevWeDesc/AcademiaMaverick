...
export const Feedbacks = () => {
  ...
  return (
    <div className="font-sans pt-12 lg:py-20 pb-5 bg-gradient-to-r from-black to-zinc-800 text-white">
      <div className="pt-12 pb-7 flex flex-col gap-7 items-center px-5 lg:px-44 max-w-[1700px] m-auto 4xl:px-0">
