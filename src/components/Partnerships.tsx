...
export const Partnerships = () => {
  return (
    <div className="bg-black text-white flex flex-col px-5 pt-[100px] pb-20 gap-5 items-center md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 lg:px-36 lg:py-28 max-w-[1700px] m-auto">
